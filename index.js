  ...
  if (message.author.bot) return;
    ...
    if(commandfile) commandfile.run(bot,message,args);
     ...
     if (msg.startsWith ("mocchi")) {
       ...
       return message.channel.send("Bliss! ε===(っ≧ω≦)っ");
     }
   ...
   if(msg.startsWith (prefix + "rank")) {
       ...
       var random = Math.floor (Math.random() * (number)) + 1;
       switch (random) {
         case 1: message.channel.send ("Yay! Let's celebrate with momorin!"); break;
         case 2: message.channel.send ("You did your best! I'm going to praise you!"); break;
         case 3: message.channel.send ("You got a passing grade!"); break;
         case 4: message.channel.send ("We're going to have intense special training tomorrow!"); break;
         case 5: message.channel.send ("Uuu... What happened?"); break;
      }
    }
    ...
    if(msg.startsWith (prefix + "scout")) {
      ...
      // message.react(emoji);
        ...
        var random = Math.floor (Math.random() * (number)) + 1;
        switch (random) {
          case 1: message.channel.send ({files:["./images/momo_birthday_sr.png"]}); break;
          case 2: message.channel.send ({files:["./images/momo_birthday_ssr.png"]}); break;
          case 3: message.channel.send ({files:["./images/momo_disone_ssr.png"]}); break;
          case 4: message.channel.send ({files:["./images/momo_esperanza_ssr.png"]}); break;
          case 5: message.channel.send ({files:["./images/momo_gardentea_ssr.png"]}); break;
          case 6: message.channel.send ({files:["./images/momo_gothichalloween_ssr.png"]}); break;
          case 7: message.channel.send ({files:["./images/momo_kingpudding_ssr.png"]}); break;
          case 8: message.channel.send ({files:["./images/momo_kiseki_ur.png"]}); break;
          case 9: message.channel.send ({files:["./images/momo_linked_ssr.png"]}); break;
          case 10: message.channel.send ({files:["./images/momo_lullaby_ssr.png"]}); break;
          case 11: message.channel.send ({files:["./images/momo_marchen_ssr.png"]}); break;
          case 12: message.channel.send ({files:["./images/momo_monster_sr.png"]}); break;
          case 13: message.channel.send ({files:["./images/momo_monster_ssr.png"]}); break;
          case 14: message.channel.send ({files:["./images/momo_nodoubt_sr.png"]}); break;
          case 15: message.channel.send ({files:["./images/momo_nodoubt_ssr.png"]}); break;
          case 16: message.channel.send ({files:["./images/momo_order_ssr.png"]}); break;
          case 17: message.channel.send ({files:["./images/momo_ordinarydays_r.png"]}); break;
          case 18: message.channel.send ({files:["./images/momo_ordinarydays_sr.png"]}); break;
          case 19: message.channel.send ({files:["./images/momo_ordinarydays_ssr.png"]}); break;
          case 20: message.channel.send ({files:["./images/momo_rabbit_sr.png"]}); break;
          case 21: message.channel.send ({files:["./images/momo_rabbit_ssr.png"]}); break;
          case 22: message.channel.send ({files:["./images/momo_rehearsal_sr.png"]}); break;
          case 23: message.channel.send ({files:["./images/momo_rehearsal_ssr.png"]}); break
          case 24: message.channel.send ({files:["./images/momo_rehearsal_ur.png"]}); break;
          case 25: message.channel.send ({files:["./images/momo_sparkle_ssr.png"]}); break;
          case 26: message.channel.send ({files:["./images/momo_xmasmagic_ssr.png"]}); break;
          case 27: message.channel.send ({files:["./images/momo_sweets_ssr.png"]}); break;
          case 28: message.channel.send ({files:["./images/momo_taiko_ssr.png"]}); break;
          case 29: message.channel.send ({files:["./images/momo_taisho_ssr.png"]}); break;
          case 30: message.channel.send ({files:["./images/momo_valentine_ssr.png"]}); break;
          case 31: message.channel.send ({files:["./images/momo_whiteday_sr.png"]}); break;
          case 32: message.channel.send ({files:["./images/momo_whiteday_ssr.png"]}); break;
          case 33: message.channel.send ({files:["./images/momo_winter_sr.png"]}); break;
          case 34: message.channel.send ({files:["./images/momo_winter_ssr.png"]}); break;
          case 35: message.channel.send ({files:["./images/momo_work_sr.png"]}); break;
          case 36: message.channel.send ({files:["./images/momo_work_ssr.png"]}); break;
          case 37: message.channel.send ({files:["./images/momo_xmasrock_ssr.png"]}); break;
          case 38: message.channel.send ({files:["./images/momo_zodiac_ssr.png"]}); break;
          case 39: message.channel.send ({files:["./images/momo_visualartexpo_ssr.png"]}); break;
          case 40: message.channel.send ({files:["./images/momo_shuffle_ssr.png"]}); break;
          case 41: message.channel.send ({files:["./images/momo_visualartexpo_ssr.png"]}); break;
        }
      }
